...
<html>
  <head>
   <meta charset="utf-8">
	...
	<!--title-->
    <title>PlaceMeantforU Exam</title>
      ...
      <noscript><h2>For the proper Functionality, You must use Javascript enabled Browser</h2></noscript>
       ...
       <?php
          ...
          ?>
             ...
             <textarea cols="100" rows="12" name="question" readonly style="width:100%;text-align:left;margin-top:2px;font-size:120%;font-weight:bold;margin-bottom:0;color:#0000ff;padding:2px 2px 2px 2px;"><?php echo htmlspecialchars_decode($r['question'],ENT_QUOTES); ?></textarea>
              <table border="0" width="100%" class="ntab">
                  <tr><td>&nbsp;</td></tr>
